...
class SignTrans extends StatefulWidget {

  @override
  _SignTransState createState() => _SignTransState();
}

class _SignTransState extends State<SignTrans> {
  ...
  Widget build(BuildContext context) {
    ...
    return chargement ? Chargement() : Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: Text("Formulaire de renseignement", style: TextStyle(color: Colors.blue),),
        elevation: 10,
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () async{
                      if(_formKey.currentState.validate()){
                        ...
                        bool toto =await asynnnb();
                        toto ? Fluttertoast.showToast(msg: "Enregistrer avec succes",
